...
interface CourseOutlinesFilterProps {
  schools: any[];
  departments: any[];
  programs: any[];
  courses: any[];
...
export function CourseOutlinesFilter({
  schools,
  departments,
  programs,
  courses,
  ...
  return (
    ...
    >
      <div className="sticky top-0 flex items-center justify-between p-4 bg-amber-50 lg:hidden z-40 border-b border-amber-200">
        <h2 className="font-bold text-gray-800">Course Outlines Filters</h2>
        <button
          onClick={onClose}
      ...
      <div className="hidden lg:block p-4 bg-amber-50 border-b border-amber-200 flex-shrink-0">
        <h2 className="font-bold text-gray-800">Course Outlines</h2>
        <p className="text-xs text-gray-900 mt-1">Find course syllabi</p>
      </div>
