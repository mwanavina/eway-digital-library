...
export function JournalsFilter({
  ...
  return (
    ...
    >
      <div className="sticky top-0 flex items-center justify-between p-4 bg-purple-50 lg:hidden z-40 border-b border-purple-200">
        <h2 className="font-bold text-gray-800">Journals & Research Filters</h2>
        <button
          onClick={onClose}
      ...
      <div className="hidden lg:block p-4 bg-purple-50 border-b border-purple-200 flex-shrink-0">
        <h2 className="font-bold text-gray-800">Journals & Research Papers</h2>
        <p className="text-xs text-gray-900 mt-1">Filter by academic area</p>
      </div>
