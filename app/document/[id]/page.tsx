    ...
    return (
      <div className="min-h-screen bg-background dark:bg-slate-950 pb-20">
        <div className="sticky top-0 z-40 bg-background dark:bg-slate-950 border-b border-gray-200 dark:border-slate-700">
          <Link href="/" className="p-4 inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
            <ArrowLeft size={20} />
            Back
          </Link>
        </div>
        <div className="p-4 text-center py-12">
          <p className="text-gray-600 dark:text-slate-300">Document not found</p>
        </div>
      </div>
    );
  }
      ...
      <div className="p-4 md:p-6 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <button
            ...
            className="w-24 h-24 rounded-xl flex items-center justify-center text-white shadow-lg mb-2 transition-transform hover:scale-105 cursor-pointer"
            style={{ backgroundColor: typeColor }}
            aria-label="Preview document"
          >
            <FileText size={48} />
          </button>
          <p className="text-xs text-gray-500 dark:text-slate-400 mb-4">Tap to preview</p>
        ...
        <div className="bg-gray-50 dark:bg-slate-800/60 rounded-lg p-4 mb-6 border border-gray-200 dark:border-slate-700">
          ...
          <div className="space-y-2 text-sm">
            <div>
              <p className="text-gray-600 dark:text-slate-400">Course Code</p>
              <p className="font-semibold text-gray-900 dark:text-slate-100">{document.course_code}</p>
            </div>
            <div>
              <p className="text-gray-600 dark:text-slate-400">Course Name</p>
              <p className="font-semibold text-gray-900 dark:text-slate-100">{document.course_name}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-slate-800/60 rounded-lg p-4 mb-6 border border-gray-200 dark:border-slate-700">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-gray-600 dark:text-slate-400">School</p>
              <p className="font-semibold text-gray-900 dark:text-slate-100">{document.school_name}</p>
            </div>
            <div>
              <p className="text-gray-600 dark:text-slate-400">Department</p>
              <p className="font-semibold text-gray-900 dark:text-slate-100">{document.department_name}</p>
            </div>
          </div>
        </div>
        ...
        {document.resource_type_name === 'Past Papers' && (
          <div className="bg-gray-50 dark:bg-slate-800/60 rounded-lg p-4 mb-6 border border-gray-200 dark:border-slate-700">
            ...
            <div className="space-y-2 text-sm">
              {document.year && (
                <div>
                  <p className="text-gray-600 dark:text-slate-400">Year</p>
                  <p className="font-semibold text-gray-900 dark:text-slate-100">{document.year}</p>
                </div>
              )}
              {document.semester && (
                <div>
                  <p className="text-gray-600 dark:text-slate-400">Semester</p>
                  <p className="font-semibold text-gray-900 dark:text-slate-100">Semester {document.semester}</p>
                </div>
              )}
              {document.exam_type && (
                <div>
                  <p className="text-gray-600 dark:text-slate-400">Exam Type</p>
                  <p className="font-semibold text-gray-900 dark:text-slate-100">{document.exam_type}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <>
            {document.author && (
              <div className="bg-gray-50 dark:bg-slate-800/60 rounded-lg p-4 mb-6 border border-gray-200 dark:border-slate-700">
                ...
                <p className="font-semibold text-gray-900 dark:text-slate-100 text-sm">{document.author}</p>
              </div>
            )}
            ...
            {document.abstract && (
              <div className="bg-gray-50 dark:bg-slate-800/60 rounded-lg p-4 mb-6 border border-gray-200 dark:border-slate-700">
                ...
                <p className="text-gray-700 dark:text-slate-300 text-sm leading-relaxed">{document.abstract}</p>
              </div>
            )}
          </>
        )}
          ...
          <>
            ...
            {document.year && (
              <div className="bg-gray-50 dark:bg-slate-800/60 rounded-lg p-4 mb-6 border border-gray-200 dark:border-slate-700">
                ...
                <p className="font-semibold text-gray-900 dark:text-slate-100 text-sm">{document.year}</p>
              </div>
            )}
          </>
        )}
        ...
        <div className="bg-gray-50 dark:bg-slate-800/60 rounded-lg p-4 mb-6 border border-gray-200 dark:border-slate-700">
          <h2 className="font-semibold text-gray-900 dark:text-white mb-3 uppercase text-sm tracking-wide">
            Related Resources
          </h2>
          <div className="space-y-2 text-sm">
            <Link
              href={`/?courseCode=${document.course_code}`}
              className="flex items-center text-[#1782C5] dark:text-blue-400 hover:underline font-medium"
            >
